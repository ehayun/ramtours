                ...
                <div class="body">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" href="javascript:void(0)"
                                data-toggle="tab">Package Info</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="javascript:void(0)">Meta
                                data</a></li>
                    </ul>
                    @show
                    <form action="{{url('admin/package')}}@yield('edit_package_id')" id="add_package" method="POST"
                        ...
                        <div class="form-group form-float">
                            ...
                            <div class="form-line">
                                ...
                                <input type="text" class="form-control" name="package_title"
                                    value="{!! get_edit_input_pvr_old_value_with_obj('package_title',$package, 'package_title')!!}">
                        ...
                        <div class="form-group form-float">
                            ...
                            <input type="radio" name="is_display_pkg_title" id="yes" class="with-gap radio-col-amber"
                                value="1"
                                {!!get_edit_select_check_pvr_old_value_with_obj('is_display_pkg_title',$package,'is_display_pkg_title',1, 'chacked'
                                )!!}>

                            <label for="yes" class="m-l-10 m-r-10">yes</label>

                            <input type="radio" name="is_display_pkg_title" id="no" class="with-gap radio-col-amber"
                                value="0"
                                {!!get_edit_select_check_pvr_old_value_with_obj('is_display_pkg_title',$package,'is_display_pkg_title',0, 'chacked'
                                )!!}>
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <select class="form-control show-tick rami_package_type" name="package_type" value="">
                                    ...
                                    {{-- <option value="2" {{ get_edit_select_check_pvr_old_value_with_obj('package_type', $package, 'package_type', '2', 'select')}}>flight+Hotel
                                    </option> --}}
                                    <option value="3"
                                        {{ get_edit_select_check_pvr_old_value_with_obj('package_type', $package, 'package_type', '3', 'select')}}>
                                        flight+car</option>
                                    {{--  <option value="4"{{ get_edit_select_check_pvr_old_value_with_obj('package_type', $package, 'package_type', '4', 'select')}}>flight
                                    </option>
                                    <option value="5"
                                        {{ get_edit_select_check_pvr_old_value_with_obj('package_type', $package, 'package_type', '5', 'select')}}>
                                        Accomodation</option> --}}
                                </select>
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <textarea class="ckeditor"
                                    name="package_desc">{!! get_edit_input_pvr_old_value_with_obj('package_desc',$package,'package_desc')!!}</textarea>
                            ...
                            <div class="form-line">
                                <select class="form-control show-tick" name="package_flight_location"
                                    ...
                                    <option value="{{$location->id}}"
                                        {{get_edit_select_check_pvr_old_value_with_obj('package_flight_location', $package, 'package_flight_location', $location->id, 'select')}}>
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" class="form-control flight_start_date" name="package_start_date"
                                    value="{!! get_edit_input_pvr_old_value_with_obj('package_start_date',$package, 'package_start_date')!!}">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" class="form-control flight_start_date" name="package_end_date"
                                    value="{!! get_edit_input_pvr_old_value_with_obj('package_end_date',$package, 'package_end_date')!!}">
                                {!! get_form_error_msg($errors, 'package_end_date') !!}
                            </div>
                        </div>
                        <div class="form-group form-float rami_airline_all">
                            <div class="form-line">
                                <select class="form-control show-tick package_airline" name="package_airline[]"
                                    id="airline_id" data-live-search="true" multiple="">
                                    <option value="">Select Airline</option>
                                    @if(!empty($airlines))
                                    @foreach($airlines as $airline)
                                    <option value="{{$airline->id}}"
                                        {{ get_edit_select_check_pvr_old_value_with_obj_serlizie('package_airline', $package, 'package_airline', $airline->id ,'select')}}>
                                        {{$airline->airl_title}}</option>
                                    @endforeach
                                    @endif
                                </select>
                        ...
                        <div class="form-group form-float rami_airline_all">
                            <div class="form-line">
                                <select class="form-control show-tick package_flight_sche" name="package_flight_sche[]"
                                    id="flight_sche_id" multiple="" data-live-search="true"
                                    prv_flight_sche="{{ rami_get_prv_serialize_data('package_flight_sche',$package, 'package_flight_sche') }}">
                        ...
                        <div class="form-group form-float rami_hotel_all">
                            <div class="form-line">
                                <select class="form-control show-tick package_hotel" name="package_hotel"
                        ...
                        <div class="form-group form-float rami_car_pack">
                            <div class="form-line">
                                <select class="form-control show-tick package_car" name="package_car[]" id="car_id"
                                    ...
                                    prv_car="{{ rami_get_prv_serialize_data('package_car',$package, 'package_car') }}">
                        ...
                        <div class="form-group form-float">
                            ...
                            <input type="radio" name="package_profit_type" id="flat" class="with-gap radio-col-amber"
                                value="1"
                                {!!get_edit_select_check_pvr_old_value_with_obj('package_profit_type',$package,'package_profit_type',1, 'chacked'
                                )!!}>

                            <label for="flat" class="m-l-10 m-r-10">flat</label>

                            <input type="radio" name="package_profit_type" id="per" class="with-gap radio-col-amber"
                                value="2"
                                {!!get_edit_select_check_pvr_old_value_with_obj('package_profit_type',$package,'package_profit_type',2, 'chacked'
                                )!!}>
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <select class="form-control show-tick profit_currency" name="profit_curr">
                                    <option value="1"
                                        {{get_edit_select_check_pvr_old_value_with_obj('profit_curr', $package, 'profit_curr', 1, 'select')}}>
                                        USD</option>
                                    <option value="2"
                                        {{get_edit_select_check_pvr_old_value_with_obj('profit_curr', $package, 'profit_curr', 2, 'select')}}>
                                        Euro </option>
                                    <option value="3"
                                        {{get_edit_select_check_pvr_old_value_with_obj('profit_curr', $package, 'profit_curr', 3, 'select')}}>
                                        Swiss Franc</option>
                                    <option value="4"
                                        {{get_edit_select_check_pvr_old_value_with_obj('profit_curr', $package, 'profit_curr', 4, 'select')}}>
                                        Shekel</option>
                                </select>
                        ...
                        <div class="form-group form-float rami_fhc_pack">
                            <div class="form-line">
                                <input type="text" class="form-control" name="package_profit_fhc"
                                    value="{!! get_edit_input_pvr_old_value_with_obj('package_profit_fhc',$package, 'package_profit_fhc')!!}">
 ...
 --}}
                        <div class="form-group form-float rami_fc_pack">
                            ...
                            <div class="form-line">
                                ...
                                <input type="text" class="form-control" name="package_profit_fc"
                                    value="{!! get_edit_input_pvr_old_value_with_obj('package_profit_fc',$package, 'package_profit_fc')!!}">
                        ...
                        <div class="form-group form-float">
                            ...
                            <input type="radio" name="is_hot_deal" id="hot_yes" class="with-gap radio-col-amber"
                                value="1"
                                {!!get_edit_select_check_pvr_old_value_with_obj('is_hot_deal',$package,'is_hot_deal',1, 'chacked'
                                )!!}>

                            <label for="hot_yes" class="m-l-10 m-r-10">yes</label>

                            <input type="radio" name="is_hot_deal" id="hot_no" class="with-gap radio-col-amber"
                                value="0"
                                {!!get_edit_select_check_pvr_old_value_with_obj('is_hot_deal',$package,'is_hot_deal',0, 'chacked'
                                )!!}>
                        ...
                        <div class="form-group form-float">
                            ...
                            <input type="radio" name="instant_approval" id="ins_yes" class="with-gap radio-col-amber"
                                value="1"
                                {!!get_edit_select_check_pvr_old_value_with_obj('instant_approval',$package,'instant_approval',1, 'chacked'
                                )!!}>

                            <label for="ins_yes" class="m-l-10 m-r-10">yes</label>

                            <input type="radio" name="instant_approval" id="ins_no" class="with-gap radio-col-amber"
                                value="0"
                                {!!get_edit_select_check_pvr_old_value_with_obj('instant_approval',$package,'instant_approval',0, 'chacked'
                                )!!}>
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <br><br>
                                <textarea name="pkg_instruction_text" rows="5"
                                    style="width:100%;margin-top: -20px">{!! get_edit_input_pvr_old_value_with_obj('pkg_instruction_text',$package,'pkg_instruction_text')!!}</textarea>
                                {!! get_form_error_msg($errors, 'pkg_instruction_text') !!}
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <label class="profit">Package Status : </label>
                            <input type="radio" name="package_status" id="active" class="with-gap radio-col-amber"
                                value="1"
                                {!!get_edit_select_check_pvr_old_value_with_obj('package_status',$package,'package_status',1, 'chacked'
                                )!!}>
                            <label for="active" class="m-l-10 m-r-10">Active</label>
                            <input type="radio" name="package_status" id="Inactive" class="with-gap radio-col-amber"
                                value="0"
                                {!!get_edit_select_check_pvr_old_value_with_obj('package_status',$package,'package_status',0, 'chacked'
                                )!!}>
