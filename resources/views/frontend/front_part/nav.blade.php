<nav class="navbar navbar-expand-lg navbar-dark fixed-top rtmenu" id="mainNav">
   <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="{{ url('/') }}"><img
            src="{{url('/assets/front/images')}}/logo.png"></a>
      <div class="collapse navbar-collapse">
         ...
         <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item dropdown">
               ...
               <ul class="dropdown-menu" role="menu">
                  <li class=""><a href="{{ url('/package-category/21') }}" class="dropdown-item">חבילות נופש באיזור היער
                        השחור גרמניה</a></li>
                  {{-- <li class=""><a href="{{ url('/package-category/44') }}" class="dropdown-item">חבילות ליער השחור
                  ראש השנה סוכות</a>
            </li> --}}
            <li class=""><a href="{{ url('/package-category/82') }}" class="dropdown-item">חבילות וכפרי נופש ברחבי
                  הולנד</a></li>
            <li class=""><a href="{{ url('/package-category/55') }}" class="dropdown-item">חבילות נופש באיזור זלצבורג
                  אוסטריה</a></li>
            <!-- <li class=""><a href="{{ url('/package-category/53') }}" class="dropdown-item">חבילות נופש לאוסטריה בסוכות</a></li> -->
            <li class=""><a href="{{ url('/package-category/54') }}" class="dropdown-item">חבילות נופש באיזור טירול
                  אוסטריה</a></li>
         ...
         {{--  <li class="nav-item dropdown">
                     ...
                     <ul class="dropdown-menu" role="menu">
                        <li class=""><a href="{{ url('/fly-travel-packages') }}" class="dropdown-item">חבילות טוס וסע
         לפרנקפורט</a></li>
         ...
         <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
               <li><a href="{{ url('/הכרטיס-האדום-של-היער-השחור-hochschwarzwald-card') }}" class="dropdown-item">כרטיס
                     אדום</a></li>
               <li><a href="{{ url('/כרטיס-היער-השחור-החדש-schwarzwaldcard') }}" class="dropdown-item">הכרטיס השחור
                     החדש</a></li>
         ...
         <li class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle {{ get_rami_active_menu('tourist-info') }}" id="navbarDropdown"
               role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">מידע למטייל</a>
            <ul class="dropdown-menu" role="menu">
               <li class="dropdown-item dropdown">
               ...
               <li class="dropdown-item"><a href="{{ url('/כפר-נופש-בהולנד-למשפחות') }}">כפר נופש בהולנד למשפחות</a>
               </li>
         ...
         <li class="dropdown-item dropdown">
            ...
            <ul class="dropdown-menu">
               ...
               <li class="dropdown-item"><a href="{{ url('/package-category/דילים-ליער-השחור') }}">דילים ליער השחור</a>
               </li>
               ...
               <li class="dropdown-item"><a href="{{ url('/טיול-מאורגן-ליער-השחור-למשפחות') }}">טיול מאורגן ליער השחור
                     למשפחות</a></li>
               ...
               <li class="dropdown-item"><a href="{{ url('/כרטיס-היער-השחור-החדש-schwarzwaldcard') }}">כרטיס היער
                     השחור</a></li>
               <li class="dropdown-item"><a href="{{ url('/מלונות-מומלצים-ביער-השחור') }}">מלונות ביער השחור</a></li>
               <li class="dropdown-item"><a href="{{ url('/accomodation/לינה-ביער-השחור') }}">אפשרויות לינה ביער
                     השחור</a></li>
               <li class="dropdown-item"><a href="{{ url('/צימרים-ודירות-נופש-ביער-השחור') }}">צימרים ודירות נופש ביער
                     השחור</a></li>
         ...
         <li class="dropdown-item dropdown">
            ...
            <ul class="dropdown-menu">
               ...
               <li class="dropdown-item"><a href="{{ url('/טיסות-לבריסל-בריסל-איירליינס') }}">טיסות לבריסל בריסל
                     איירליינס</a></li>
         ...
         <li class="nav-item">
            <a class="nav-link js-scroll-trigger {{ get_rami_active_menu('contact') }}" href="{{ url('/contact') }}">צור
               קשר</a>
         </li>
